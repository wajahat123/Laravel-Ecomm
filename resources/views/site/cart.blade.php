                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="cart">
                                ...
                                <h1 class="cart-title">In Your Shopping Cart: <span
                                        class="c-primary">{{ session('cart') ? count(session('cart')) : 0 }}</span></h1>
                            ...
                            @if (session('cart'))
                                    ...
                                    <table class="shop_table cart">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach (session('cart') as $cartItems)
                                                @php
                                                    $cartTotal += $cartItems['Price'] * $cartItems['quantity'];
                                                @endphp
                                                <tr class="cart_item">
                                                    ...
                                                    <td class="product-thumbnail">
                                                        ...
                                                        <div class="cart-product__item">
                                                            <a href="#">
                                                                <img src="{{ asset('assets/site/img/cart-product4.png') }}"
                                                                    alt="product"
                                                                    class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                            </a>
                                                            <div class="cart-product-content">

                                                                <h5 class="cart-product-title">{{ $cartItems['name'] }}</h5>
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td class="product-price">
                                                        <h5 class="price amount">{{ $cartItems['Price'] }}</h5>
                                                    </td>
                                                    ...
                                                    <td class="product-subtotal">
                                                        <h5 class="total amount">
                                                            {{ $cartItems['Price'] * $cartItems['quantity'] }}</h5>
                                                    </td>
                                ...
                                <div class="cart-total">
                                    ...
                                    <h5 class="cart-total-total">Total: <span class="price">{{ env('PRODUCT_CURRENCY') }}
                                            {{ $cartTotal }}</span></h5>
