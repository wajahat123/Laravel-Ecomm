          ...
          <div class="product-details">
                          ...
                          <div class="swiper-wrapper">
                              ...
                              @foreach ($product->images as $item)
                                ...
                                <div class="product-details-img-wrap swiper-slide">
                                    <img src="/{{ $item->image }}" alt="product" data-swiper-parallax="-10">
                                </div>
                              @endforeach
                          </div>
                      </div>
              ...
              <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                  <div class="product-details-info">
                      ...
                      <div class="product-details-info-price">{{ env('PRODUCT_CURRENCY') . $product->Price}}</div>
                      ...
                      <div class="quantity">
                          ...
                          <input title="Qty" class="email input-text qty text" type="text" value="{{$product->quantity}}">
